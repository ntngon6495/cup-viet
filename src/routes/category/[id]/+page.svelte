...
<div class="w-full text-center mt-10">
  <p
    class="sm:text-4xl text-2xl sm:mt-0 mt-10 font-bold uppercase text-yellow-400"
  >
  ...
  <div class="grid grid-cols-12 sm:gap-5">
    {#each productList as item}
      ...
      >
        <img src={item.image_url} class="sm:max-w-[400px] max-w-[200px] bg-gray-100" alt="" />
        <div class="sm:text-2xl text-sm font-bold text-[#F3B81A] sm:px-0 flex w-full gap-2 justify-center mt-5">
          {item.product_code}
        </div>
