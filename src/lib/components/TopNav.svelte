...
>
  <div class="sm:flex hidden h-full w-[1200px]">
    ...
    {#if listCategory}
      <div
        class="bg-[white] absolute top-[110px] opacity-100 border border-[#225A42] shadow-lg"
      >
        <div class="flex justify-center items-center h-[65px]">
          {#each listCategory as { id, name }}
            <a
              class="text-[#225A42] text-[16px] font-semibold h-full uppercase category-style"
            ...
            <a
              class="text-[#225A42] text-[16px] font-semibold h-full uppercase hidden category-style"
...
<style lang="scss">
  ...
  .text-green {
    color: #225A42 !important;
  }
  .background_left {
    background: linear-gradient(102deg, #225A42 50%, #ffcd36 50%);
  }
  .background_right {
    background: linear-gradient(102deg, #ffcd36 50%, #225A42 50%);
  }
  .background_left_sb {
